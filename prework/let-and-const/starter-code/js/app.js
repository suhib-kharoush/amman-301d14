...
function displayPics(){
  ...
  // var statement is used to declare a variable in JavaScript,  A variable declared with the var keyword is defined throughout the program. let statement is used to declare a local variable. 
